...
val SUPPORTED_FEATURES = listOf(
    ...
    "MediaSession control — play/pause/next/previous/stop এবং ১–৩০০ second forward/rewind",
    "Media volume direct up/down/mute/unmute এবং exact ০–১০০%; Android safe-volume rules respected",
    "ক্যামেরা খোলা (ছবি/ভিডিও মোড); ছবি তোলার কমান্ডে ক্যাপচার স্ক্রিন — শাটার আপনার হাতে",
    "Android picker দিয়ে file open/read/rename/copy/move/delete/multi-share এবং selected PDF system print preview",
