...
val SUPPORTED_FEATURES = listOf(
    ...
    "দৈনন্দিন calculator — BMI, আনুমানিক EMI, গাড়ির mileage, age, দুই তারিখের পার্থক্য, কত দিন বাকি, weekday, coin/dice/random",
...
val UNSUPPORTED_FEATURES = listOf(
    ...
    FeatureRow("ফাইল কন্টেন্ট সার্চ / গ্যালারিতে মিডিয়া খোঁজা", false, "Android-এর স্টোরেজ পারমিশন মডেল ভার্সনভেদে ভিন্ন; ফাইল/গ্যালারি অ্যাপ খোলা সাপোর্টেড, ভেতরে সার্চ আপাতত নয়।"),
